## beethoven-string-quartets Makefile
##
## Programmer:    Craig Stuart Sapp <craig@ccrma.stanford.edu>
## Creation Date: Tue Jun  3 18:03:42 PDT 2014
## Last Modified: Tue Jun  3 18:03:46 PDT 2014
## Filename:      Makefile
## Syntax:        GNU/BSD makefile
##
## Description:   Makefile for basic processing Humdrum data files 
##                for the quartets of Ludwig van Beethoven.
##
...
#           git clone https://github.com/craigsapp/beethoven-quartets
#
...
kernscores: humdrum-extras-check
	mkdir -p kernscores; (cd kernscores && humsplit h://beethoven/quartets)
	@echo "[0;32m"
...
ifeq ($(shell which curl),)
	...
	for file in kern/*.krn; do \
	   ...
	   curl \
	      "http://kern.humdrum.org/data?l=beethoven/quartets&file=$$TBASE.krn&format=pdf" \
...
#    tindex kern/prelude28-04.krn | themax -I "+P4 +P4" --loc | theloc --mark | myank --marks
#
#
...
ifeq ($(wildcard .git),)
	...
	@echo "***    [0;32mgit clone https://github.com/craigsapp/beethoven-quartets[0;31m"
	@echo "[0m"
	exit 1
endif
